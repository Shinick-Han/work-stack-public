...
export function TableView({ onChangeTaskStatus, onSelectTask, onSelectObjective, selectedTaskId, keyResultProjection, onSelectOutcome, tasks, referenceTasks = tasks, today: providedToday }: TableViewProps) {
