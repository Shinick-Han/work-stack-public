...
- [`WorkStack-Setup-1.0.2.ps1`](https://github.com/Shinick-Han/work-stack-public/releases/download/v1.0.2/WorkStack-Setup-1.0.2.ps1)
- [`WorkStack-Setup-1.0.2.ps1.sha256`](https://github.com/Shinick-Han/work-stack-public/releases/download/v1.0.2/WorkStack-Setup-1.0.2.ps1.sha256)

The same self-contained installer is also committed with this public snapshot:

- [`installer/WorkStack-Setup-1.0.2.ps1`](installer/WorkStack-Setup-1.0.2.ps1)
- [`installer/WorkStack-Setup-1.0.2.ps1.sha256`](installer/WorkStack-Setup-1.0.2.ps1.sha256)
...
Run the generated `.artifacts\WorkStack-Setup-1.0.2.ps1`. The target machine needs neither
...
The builder also writes `WorkStack-Setup-1.0.2.ps1.sha256`. Keep it beside the setup artifact
and verify both the filename and digest before execution:

```powershell
.\scripts\windows\Test-WorkStackSetup.ps1 `
  -SetupPath .\.artifacts\WorkStack-Setup-1.0.2.ps1
```
