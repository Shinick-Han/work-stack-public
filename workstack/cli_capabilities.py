...
ONLINE_ROUTES = frozenset({
    ...
    "owner_get:/api/v1/cli/backlog",
    "owner_get:/api/v1/cli/backlog/{id}",
...
CAPABILITY_ROWS: tuple[tuple[object, ...], ...] = (
    ...
    ("backlog.list", "task", "list", False, False, "owner_get:/api/v1/cli/backlog", "stack:backlog", "none", False, False),
    ("backlog.show", "task", "show", False, False, "owner_get:/api/v1/cli/backlog/{id}", "stack:backlog", "none", False, False),
    ...
    ("okr.list", "objective", "list", False, False, "owner_get:/api/v1/cli/okr", "stack:okr", "none", False, False),
    ...
    ("okr.rollup", "objective", "rollup", False, False, "owner_get:/api/v1/cli/okr/rollup", "stack:okr", "none", False, False),
...
EXCLUSION_ROWS: tuple[tuple[object, ...], ...] = (
    ...
    ("GET /api/v1/tasks/{id}", "http_get", "GUI task projection drops status_fact_id; CLI uses GET /api/v1/cli/backlog/{id}"),
